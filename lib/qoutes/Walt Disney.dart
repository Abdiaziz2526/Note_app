...
class waltQout extends StatelessWidget {
  const waltQout({super.key});
                     ...
                     children: [
                      SizedBox(height: 30,),
                       ...
                       Padding(
                         ...
                         child: Text("Walt Disney", style: TextStyle(
                       ...
                       Padding(
                         padding: const EdgeInsets.only(left: 45),
                         child: Text("I always like to look on the optimistic, am realistic enough a complex matter.", style: TextStyle(
                          fontSize: 18, fontWeight: FontWeight.w400, 
                         ),),
                       ),
                       SizedBox(height: 7,),
